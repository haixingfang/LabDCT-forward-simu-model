...
% % Simulation 2
% Lsam2sou = 11.0; % sample-to-source distance [mm] [11 14]
% Lsam2det = 18.0; % sample-to-detector distance [mm][11 14 18 30]
% dety0 = 1016;	% beamcenter, y in pixel coordinatees
% detz0 = 1016;	% beamcenter, z in pixel coordinatees
% detysize = 2032;      % detector y size [pixels]
% detzsize = 2032;      % detector z size [pixels]
...
% % Simulation 3
% Lsam2sou = 11.0; % sample-to-source distance [mm] [11 14]
% Lsam2det = 24.0; % sample-to-detector distance [mm][11 14 18 30]
% dety0 = 1016;	% beamcenter, y in pixel coordinatees
% detz0 = 1016;	% beamcenter, z in pixel coordinatees
% detysize = 2032;      % detector y size [pixels]
% detzsize = 2032;      % detector z size [pixels]
...
% % Simulation 4
% Lsam2sou = 11.0; % sample-to-source distance [mm] [11 14]
% Lsam2det = 30.0; % sample-to-detector distance [mm][11 14 18 30]
% dety0 = 1016;	% beamcenter, y in pixel coordinatees
% detz0 = 1016;	% beamcenter, z in pixel coordinatees
% detysize = 2032;      % detector y size [pixels]
% detzsize = 2032;      % detector z size [pixels]
...
% % Simulation 5
% Lsam2sou = 11.0; % sample-to-source distance [mm] [11 14]
% Lsam2det = 40.0; % sample-to-detector distance [mm][11 14 18 30]
% dety0 = 1016;	% beamcenter, y in pixel coordinatees
% detz0 = 1016;	% beamcenter, z in pixel coordinatees
% detysize = 2032;      % detector y size [pixels]
% detzsize = 2032;      % detector z size [pixels]
